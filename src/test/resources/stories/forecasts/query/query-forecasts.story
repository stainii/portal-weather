...
Given I have a forecast service A with order 1
And I have a forecast service B with order 2
...
And the location service has been tried for Zottegem
...
And forecast service B has not been tried
And the location service has not been tried
